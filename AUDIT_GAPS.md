...
| AGT-013 | **Cinci** pagini randează titluri hardcodate în română indiferent de limbă (`bibliography`, `progress`, `gamification`, `exam-bank`, `admin/exam-bank`). Traducerile NU lipsesc — 859↔859 chei, zero diferențe, iar pentru toate cinci există valoare engleză distinctă. Corectat de la 6 la 5: `licenta` are aceeași valoare în en.json și ro.json (nume propriu al examenului), deci nu e defect de traducere | P2 | **Fixed** — 2026-08-15 `dcf34f6` (chei dedicate, romana pastrata litera cu litera) | `src/app/[locale]/dashboard/bibliography/page.tsx:66` · **VERIFICAT PE PROD** pe /en: Bibliography, Statistics, Achievements, Simulations - official exams; pagina de admin isi pastreaza titlul distinct · **COMPLETAT** dupa re-verificare: cautarea initiala acoperea doar page.tsx si ratase 2 layout-uri de admin cu h1 hardcodat in ENGLEZA (afisat si pe /ro) + 1 componenta. Fixate in `1450525`; verificat pe prod: /ro da [Administrare, Banca examene (vizualizare)], /en da [Admin Dashboard, Exam bank (view only)] |
