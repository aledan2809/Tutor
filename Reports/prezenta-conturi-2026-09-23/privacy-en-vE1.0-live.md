...
**Data Controller**: {entity_name} · **Jurisdiction**: {entity_jurisdiction}
**VAT / Registration No.**: {entity_cui} · **Address**: {entity_address}
**Version**: {version} · **Effective from**: {effective_date}

---

This Privacy Policy describes how **{entity_name}** collects, uses, stores, and protects your personal data within the **{app_name}** application, in accordance with **Regulation (EU) 2016/679** (GDPR) and applicable Romanian law.

Please read this document carefully. If you have questions, you may contact our Data Protection Officer (DPO) at **{entity_dpo_email}**.

---

## 1. Who is your data controller

**{entity_name}** is the controller of the personal data collected through **{app_name}**.

| | |
|---|---|
| **Name** | {entity_name} |
| **Registered office** | {entity_address} |
| **VAT / Reg. No.** | {entity_cui} |
...
We have appointed an internal DPO to ensure GDPR compliance. You may contact the DPO at any time at **{entity_dpo_email}** for:

- exercising your rights (access, erasure, portability, etc.);
- questions about how we process your data;
- reports or complaints regarding data protection.
...
### 3.5 Technical data and cookies

**IP address, browser type, operating system, screen resolution**, session data and cookies — as described in the [Cookie Policy](/en/cookies/{app_slug}).
...
| Providing the core features of {app_name} | Usage data, account data | Art. 6(1)(b) — contract performance |
...
### 5.3 Other controllers in the 4PRO ecosystem
...
- **AI providers** — e.g. Google Gemini, Anthropic, Groq (USA) — **Standard Contractual Clauses**, Decision (EU) 2021/914, supplemented by the **EU-US Data Privacy Framework** where the provider is certified;
...
For recipients in countries covered by a European Commission **adequacy decision**, the transfer relies on that adequacy decision. You may request a copy of the applicable safeguards by contacting the DPO at **{entity_dpo_email}**.
...
Under GDPR, you have the following rights, which you may exercise by contacting **{entity_dpo_email}**:
...
- **Limited access**: the need-to-know principle for employees and contractors;
- **Monitoring**: access logs and intrusion detection systems;
- **Breach notification procedures**: in the event of an incident affecting your rights, we will notify you within 72 hours of discovery (or as soon as possible), in accordance with Art. 33-34 GDPR.

## 10. Cookies

We use cookies as described in the [Cookie Policy](/en/cookies/{app_slug}), which forms an integral part of this Privacy Policy.
