...
**Prezența în cont.** Cât pagina eTutor e deschisă în față, aplicația trimite o dată pe minut un semnal discret, din care reținem doar **momentele în care contul a fost pe site** (început și sfârșit de vizită; o pauză de peste 30 de minute înseamnă vizită nouă) și, la conectare, data ultimei conectări. Nu reținem ce scrii, unde apeși sau ce apare pe ecran. Aceste date le vede doar echipa de administrare a platformei — nu părinții, nu profesorii, nu alți utilizatori.
...
| Administrarea platformei: să vedem dacă și cât sunt folosite conturile, ca să sprijinim familiile care nu mai intră și să dimensionăm serviciul | Prezența în cont (momentele vizitelor, ultima conectare) | Art. 6(1)(f) — interes legitim |
...
| Prezența în cont (momentele vizitelor, ultima conectare) | 12 luni de la vizită; ultima conectare — pe durata contului |
