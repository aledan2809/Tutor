...
const RO: Copy = {
  ...
  faq: [
    ...
    { q: "Când și cum sunt plătit?", a: "Lunar prin cont bancar, peste pragul minim de 100 lei. Datele contului le dai la onboarding." },
...
const EN: Copy = {
  ...
  faq: [
    ...
    { q: "When and how am I paid?", a: "Monthly by bank transfer, above the 100 RON minimum. You provide your account details at onboarding." },
