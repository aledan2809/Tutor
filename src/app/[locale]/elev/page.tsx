...
const RO: Copy = {
  ...
  trialPoints: [
    "7 zile gratuit, cu tot pachetul (în afară de WhatsApp și SMS)",
    "Îți faci cont și îți alegi materiile — fără card",
    "Tot ce lucrezi rămâne salvat, cu puncte și streak",
  ],
  trialNote: "Când se termină cele 7 zile, alegi un plan cu un click.",
...
const EN: Copy = {
  ...
  trialPoints: [
    "7 days free, with the whole package (except WhatsApp and SMS)",
    "Create an account and pick your subjects — no card",
    "Everything you do stays saved, with points and streaks",
  ],
  trialNote: "When the 7 days are over, pick a plan in one click.",
