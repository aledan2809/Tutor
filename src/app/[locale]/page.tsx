...
export default async function LandingPage() {
  ...
  const L = ro
    ? {
        ...
        step3Desc: "Faci cont și îți salvezi scorul, streak-urile și progresul. Sau provoci un prieten la duel.",
    ...
    : {
        ...
        step3Desc: "Create an account to save your score, streaks and progress. Or challenge a friend to a duel.",
