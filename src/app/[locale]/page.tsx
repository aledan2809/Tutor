...
export default async function LandingPage() {
  ...
  const L = ro
    ? {
        ...
        freeFootnote:
          "* Demo public: gratuit oricând, fără cont. Cont gratuit: 7 zile cu tot pachetul, în afară de WhatsApp și SMS, fără card — apoi alegi un plan.",
    ...
    : {
        ...
        freeFootnote:
          "* Public demo: always free, no account. Free account: 7 days with the whole package except WhatsApp and SMS, no card — then pick a plan.",
