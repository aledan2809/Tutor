...
const publicPaths = ["/", "/try", "/scor", "/grile", "/auth/signin", "/auth/verify", "/auth/register", "/auth/forgot-password", "/auth/reset-password", "/auth/recuperare", "/terms", "/privacy", "/cookies", "/creatori", "/parinte", "/elev", "/preturi", "/anual", "/ghid-bac", "/family/join", "/posta", "/posta/proceduri"];
