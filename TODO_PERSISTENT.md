...
- **Total exam-bank prod acum: 24 papers / 432 items** (12 anterioare + 6 din 2021 + 4 din 2022 + 2 din 2023).
- **🔴 NEXT (paper 13)**: **2023 Examen v1** (`Examen_Subiect_01`/`Examen_Barem_01`) → apoi 2023 Rezervă v5 (`Rezerva_Examen_05`) = ultima oficială 2023 → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament").
