...
- **Total exam-bank prod acum: 22 papers / 396 items** (12 anterioare + 6 din 2021 + 4 din 2022).
- **🔴 NEXT (paper 11)**: **2023 Model** → apoi 2023 {Simulare, Examen v1 (`Examen_Subiect_01`), Rezervă v5 (`Rezerva_Examen_05`)} = restul de 4 oficiale → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament").
