...
- **Total exam-bank prod acum: 21 papers / 378 items** (12 anterioare + 6 din 2021 + 3 din 2022).
- **🔴 NEXT (paper 10)**: **2022 Rezervă v1** (`2022_EN_Matematica_Rezerva_Examen_{Subiect,Barem}_01_LRO.pdf`) → completează 2022 (4/4) → apoi 2023 {Model, Simulare, Examen v1, Rezervă v5} = restul de 5 oficiale → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament").
