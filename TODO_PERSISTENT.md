...
- **Total exam-bank prod acum: 25 papers / 450 items** (12 anterioare + 6 din 2021 + 4 din 2022 + 3 din 2023).
- **🔴 NEXT (paper 14)**: **2023 Rezervă v5** (`Rezerva_Examen_Subiect_05`/`Rezerva_Examen_Barem_05`) = ULTIMA oficială 2023 (anul 2023 COMPLET 4/4) → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament CNCE", structură 18 itemi identică).
