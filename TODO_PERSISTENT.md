...
**RĂMÂNE (opțional)**: cele **8 grile A/F (TF_GRID)** Română rămân în Simulări (tipul TF_GRID nu e suportat în fluxul Question/Grile) + restul materialelor pe alte materii.
