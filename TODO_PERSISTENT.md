...
- **Total exam-bank prod acum: 26 papers / 468 items** (12 anterioare + 6 din 2021 + 4 din 2022 + 4 din 2023). **Cele 14 oficiale din `pro-matematica2` (2021×6 + 2022×4 + 2023×4) sunt TOATE importate.**
- **🔴 NEXT**: **20 teste de antrenament CNCE** (`Test_02`..`Test_15` în `pro-matematica2`, plus eventualele din `pro-matematica`) — `test-NN`, source „Test de antrenament CNCE", structură 18 itemi (SI 6 MCQ / SII 6 MCQ geometrie / SIII 6 deschis). Rețetă identică; slugs `test-01`..`test-NN`.
