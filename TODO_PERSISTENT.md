...
- [ ] **Scurgerile distribuționale, restul fețelor** (din L35) — verificate doar lungimea și poziția. De măsurat pe orice lot generat de acum: singura variantă negată, singura care se acordă gramatical cu enunțul, singura cu cifre. Filtrul de lungime + amestecarea acoperă două din listă, nu toată clasa.
