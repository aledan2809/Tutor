...
- **Total exam-bank prod acum: 20 papers / 360 items** (12 anterioare + 6 din 2021 + 2 din 2022).
- **🔴 NEXT (paper 9)**: **2022 Examen v2** (`2022_EN_Matematica_Examen_{Subiect,Barem}_02_LRO.pdf`) → apoi 2022 Rezervă v1 (`Rezerva_Examen_01`) → 2023 {Model, Simulare, Examen v1, Rezervă v5} = restul de 6 oficiale → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament").
