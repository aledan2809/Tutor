...
- [ ] **Fețele încă neverificate** — ordinea alfabetică a variantelor, lungimea explicației, tipare care se repetă între module. Și distincția rămasă deschisă: rezolvabilitatea oarbă la 95-100% e slăbiciune de proiectare (enunțul nu departajează), dar nu e dovedit exploatabilă de un elev care NU știe materia — un agent care recunoaște afirmația adevărată folosește cunoștințe, nu un indiciu. Sigur exploatabile de oricine: sintaxa și acordul. Se închide doar cu elevi reali.
