...
- **Total exam-bank prod acum: 23 papers / 414 items** (12 anterioare + 6 din 2021 + 4 din 2022 + 1 din 2023).
- **🔴 NEXT (paper 12)**: **2023 Simulare** → apoi 2023 {Examen v1 (`Examen_Subiect_01`), Rezervă v5 (`Rezerva_Examen_05`)} = restul de 2 oficiale → apoi 20 teste antrenament (`test-NN`, source „Test de antrenament").
